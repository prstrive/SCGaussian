...
from utils.loss_utils import l1_loss, ssim, get_virtual_warp_loss, get_smooth_loss
...
from utils.virtual_poses import get_near_virtual_pose
import torchvision
try:
...
def training(dataset, opt, pipe, testing_iterations, saving_iterations, checkpoint_iterations, checkpoint, debug_from):
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        # render_pkg2 = render2(viewpoint_cam, gaussians, pipe, bg)
        render_match_loss = gaussians.get_matchloss_from_renderdepth(viewpoint_cam, render_pkg["rendered_depth"], min_loss_state)
        ...
        with torch.no_grad():
            ...
            if iteration < opt.densify_until_iter:
                ...
                if iteration < opt.opacity_reset_until_iter and (iteration % opt.opacity_reset_interval == 0 or (dataset.white_background and iteration == opt.densify_from_iter)):
